document.addEventListener('DOMContentLoaded', function() {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', function(e) {
            ...
            // Get form data
            const isEmailMethod = document.getElementById('email-method').checked;
            const identifier = isEmailMethod ? 
            ...
            const mockLogin = () => {
                ...
                const userType = localStorage.getItem('userType') || 'seeker'; // Default to seeker if not set
    ...
    if (signupForm) {
        signupForm.addEventListener('submit', function(e) {
            ...
            // Get form data
            const userType = document.getElementById('owner').checked ? 'owner' : 'seeker';
            const isEmailMethod = document.getElementById('email-method').checked;
            const identifier = isEmailMethod ? 
                document.getElementById('email').value : 
                phoneInput.getNumber();
            ...
            const mockSignup = () => {
                // Store user type for login redirect
